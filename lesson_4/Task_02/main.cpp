...
TEST_CASE("Test_List", "[Test_List]")//unit тесты для проверки функций 
{
    ...
    SECTION("Проверка работы функции PushBack")
    {
        ...
        CHECK(A.Size() == 2);
        A.PushBack(3);
        //A.PopBack();//раскомментировать для имитации ошибки
        CHECK(A.Size() == 3);
    }
    SECTION("Проверка работы функции PushFront")
    {
        ...
        CHECK(A.Size() == 2);
        A.PushFront(3);
        //A.PopFront();//раскомментировать для имитации ошибки
        CHECK(A.Size() == 3);
    }
    SECTION("Проверка работы функции PopBack")
    {
        ...
        A.PushBack(11);
        A.PushBack(22);
        A.PopBack();//закомментировать для имитации ошибки удаления
        A.PopBack();
        CHECK(A.Size() == 0);//если размер отличается от заданного(0) - сообщение "Ошибка удаления элемента из конца списка" 
        //проверка на пустом списке
        A.PopBack();
        CHECK(A.Size() == 0);//ошибка из функции "List is empty"
    }
    SECTION("Проверка работы функции PopFront")
    {
        ...
        A.PushFront(11);
        A.PushFront(22);
        A.PopFront();//закомментировать для имитации ошибки удаления
        A.PopFront();
        CHECK(A.Size() == 0);//если размер отличается от заданного(0) - сообщение "Ошибка удаления элемента из начала списка" 
        //проверка на пустом списке
        A.PopFront();
        CHECK(A.Size() == 0);//ошибка из функции "List is empty"
    }
